...
<body>
    ...
    <div class="container">
        <img src="i2.jpeg" alt="Snow" style="height:50%;">
        <div class="centered">
            <div class="font-bold  mb-2">Email: easyfund@gmail.com </div>
            <div class="font-bold  mb-2">contact no: #91 7906548043</div>
            <p class="text-2xl">any sugestions are welcome</p>
